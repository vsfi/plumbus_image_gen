...
class PlumbusDrawer:
    def __init__(self, model: PlumbusModel):
        self.model = model
        self.shape_to_file = {
            "smooth": "img/plumbus_smooth.png",
            # "angular": "plumbus_angular.png",
            # "multi-angular": "plumbus_multiangular.png"
        }
    ...
    def draw(self):
        ...
        # Apply color tint only to non-transparent pixels (preserve alpha)
